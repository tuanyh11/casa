...
import { createProductComment } from "../../../../api";
...
const TabContent = ({ data }) => {
  ...
  const comments = data?.reviews?.nodes;
  ...
  return (
    <div>
      <div className="detail-tab-title font-poppins">
        <ul className="list-tag-detail list-none font-medium" role="tablist">
                  ...
                  <div className="row mx-[-60px] ">
                    <div className="w-full mb-[40px] screen-991:mb-0 screen-991:w-4/12 px-[60px] obc-product obc-product-left relative">
                      ...
                      <p className="desc">
                        ...
                        suitable for use on an open flame or electric stove top.
                        Avoid temperature shock by heating things slowly,
            ...
            <div id="tab-reviews" className="tab-pane">
              <div className="detail-tab-desc">
                ...
                <CommentSection
                  ...
                  author={author}
                  id={data?.id}
                  apiFunction={createProductComment}
                  refetch={() => {}}
                />
              </div>
            </div>
